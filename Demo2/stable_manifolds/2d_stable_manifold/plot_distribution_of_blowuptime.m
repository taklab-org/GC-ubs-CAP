function [] = plot_distribution_of_blowuptime(a,scaling,fp,nu)
...
for i = 1:M1
  parfor j = 1:M2
    ...
    P3(i,j) = nonrigorous_computation_tmax_ex3_2d(a,scaling,fp,theta,0);
  end
end

manifold = surf(P0,P1,P2,P3,'EdgeColor','none');
hold on

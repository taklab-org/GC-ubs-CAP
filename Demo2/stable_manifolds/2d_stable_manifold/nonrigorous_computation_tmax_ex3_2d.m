function t_max = nonrigorous_computation_tmax_ex3_2d(a,scaling,fp,theta,r0)
...
if fp == 1   
    lambda = [tlambda1_1.mid;tlambda1_2.mid]; 
    v1 = scaling(1)*tv1_1.mid; 
    v2 = scaling(2)*tv1_2.mid;
    tx = ip1.mid;
end

if fp == 2
    lambda = [tlambda2_1.mid tlambda2_2.mid]; 
    v1 = scaling(1)*tv2_1.mid; 
    v2 = scaling(2)*tv2_2.mid;
    tx = ip2.mid;
end

/*
 * ex3_integrate_forward_global_solution_near_p0.cc
 *
 * Validation code of a global solution from an intial point crossed over the stable manifolds attached to p_{inf,s}
 *
 ...
 *
 *
 * written  Feb. 4, 2021 Akitoshi Takayasu (with kv-0.4.48)
 *
 */
...
int main()
{
    ...
    // ps(0) = 0.836474250560393;
    // ps(1) = 0.572882744708793;
    // ps(0) = 0.832267964033316;
    // ps(1) = 0.570370294663353;
    ps(0) = 0.320682556228925;
    ps(1) = 0.319896988077054;
    for (int i = 0; i < n; i++) {
        v(i) = - ps(i);
    }
    v_normal(0) = v(1);
